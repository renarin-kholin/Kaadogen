    ...
    <div className="fixed inset-0 bg-[#1a1a1a] z-50 flex font-[Inter] text-gray-200">
      ...
      <div className="w-64 bg-[#252525] border-r border-[#333] flex flex-col p-6">
         <div className="mb-8">
            ...
            <img 
                src="https://tmpfiles.org/dl/10345021/group21.svg" 
                alt="Logo" 
         ...
         <div className="mt-auto space-y-3">
             <a href="https://github.com/acm-ioit/kaadogen" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-gray-500 hover:text-white transition-colors text-xs group">
                    ...
                    sortedProjects.map(project => (
                        ...
                        >
                            ...
                            <div className="aspect-video bg-[#1E1E1E] relative border-b border-[#333] flex items-center justify-center overflow-hidden">
                                {project.thumbnail ? (
                                    <img src={project.thumbnail} alt={project.name} className="w-full h-full object-contain opacity-80 group-hover:opacity-100 transition-opacity" />
                                ) : (
                            ...
                            <div className="p-4">
                                <div className="flex items-center justify-between mb-1">
                                    <h3 className="font-medium text-sm text-gray-200 truncate pr-2" title={project.name}>{project.name}</h3>
                                    <button 
